...
Last quality remediation campaign on the platform codebase:
...
- Designing agent platforms with strong traceability (ADR + content hash).
- Hardening quality gates to block real risk in CI.
- Productising MCP for .NET teams in data-residency-constrained environments.
